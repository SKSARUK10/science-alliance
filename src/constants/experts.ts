export const expertsContent = {
  ...
  subheading:
    "Leading the way in Ethical Research and Education on Nascent Human Life",
  experts: [
    {
      id: 1,
      image: "/img1.svg",
...
Ambassador Brownback currently serves as co-chair of the International Religious Freedom Summit and chairman of the National Committee for Religious Freedom. He continues to work with coalitions around the globe to promote and protect the fundamental human right to religious liberty and to defend human life.`,
    ...
    { id: 2, image: "/img2.jpg", name: "Expert Name", title: "Co-President & Founding Board Member" },
    { id: 3, image: "/img3.svg", name: "Expert Name", title: "Founding Board Member" },
    { id: 4, image: "/img4.jpg", name: "Expert Name", title: "Founding Board Member" },
    { id: 5, image: "/img5.svg", name: "Expert Name", title: "Founding Board Member" },
    { id: 6, image: "/img6.svg", name: "Expert Name", title: "Founding Board Member" },
    { id: 7, image: "/img7.svg", name: "Expert Name", title: "Founding Board Member" },
  ],
};